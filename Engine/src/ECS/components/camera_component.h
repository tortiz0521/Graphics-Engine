...
struct CameraComponent
{
    ...
    CameraComponent(CameraComponent&& cc) noexcept
        : front(cc.front), up(cc.up), pitch(cc.pitch), yaw(cc.yaw), mouseSense(cc.mouseSense), fov(cc.fov), moveSpeed(cc.moveSpeed)
    {
        pos = { cc.pos, &dirty };
    };
